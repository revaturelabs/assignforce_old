...
import com.revature.assignforce.security.OAuth2TokenStore;
import com.revature.assignforce.security.OAuthTokenWrapper;
...
public class Force {
    ...
    public String restUrl(String url){
        return url.replace("{version}", REST_VERSION);
    }
